...
public:
	...
	bool insert(string f, string l, int n, string j); bstNode *find(string l, string f);
	void printTreeIO();
	...
	bstNode *removeOneKid(bstNode *tmp, bool leftFlag); bstNode *remove(string f, string l);
